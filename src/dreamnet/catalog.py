...
FAULTS: tuple[Fault, ...] = (
    Fault(
        ...
        (
            ...
            "No receive light on peer-facing optic",
    ...
    Fault(
        ...
        (
            ...
            "Peer key profiles differ",
            "BGP authentication mismatch",
        ),
    ),
    Fault(
        "BGP",
        ...
        (
            "Peer does not receive prefix",
            "Deny sequence matches route",
            "Route-map filters expected prefix",
        ),
    ),
    Fault(
        "BGP",
        ...
        (
            "Path is valid but not installed",
            "Next hop has no recursive route",
    ...
    Fault(
        ...
        (
            "No outbound hello packets",
            "Interface listed passive",
            "OSPF passive interface prevents adjacency",
        ),
    ),
    Fault(
        "OSPF",
    ...
    Fault(
        "OSPF",
        "redistribution_missing",
        "policy",
        "medium",
        ("OSPF adjacency full", "External prefix absent"),
        ("show_route_source", "inspect_redistribution", "validate_export"),
        (
            "Source route exists locally",
            "No matching redistribute statement",
            "Route redistribution missing",
        ),
    ),
    Fault(
        "OSPF",
        ...
        (
            "Database exchange does not progress",
            "Network types differ",
            "OSPF network type mismatch",
        ),
    ),
    Fault(
        "OSPF",
        "acl_blocks_multicast",
        "transport",
        "high",
